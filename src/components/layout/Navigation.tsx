    ...
    <header className="relative z-50 w-full border-b-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 shadow-sm">
      <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3 group">
          <div className="relative w-10 h-10 bg-brand rounded-full flex items-center justify-center border-2 border-slate-200 dark:border-slate-700 shadow-sm group-hover:rotate-180 transition-transform duration-500 overflow-hidden">
          ...
          <span className="text-2xl font-black tracking-tighter text-slate-900 dark:text-white">
            Poké<span className="text-brand">Zen</span>
          </span>
        </Link>
